...
|-----------|-------|---------|--------------|
| **Octave Up** | 0–100% | 60% | Level of the octave-up voice in the mix. 0% = none; 100% = equal with the dry signal |
| **Octave Down** | 0–100% | 60% | Level of the octave-down voice in the mix. 0% = none; 100% = equal with the dry signal |
| **Tone** | 0–100% | 50% | Controls a low-pass filter on the output, rolling off high frequencies above a sweep range (~400–4000 Hz). Lower Tone = warmer, darker blend; higher Tone = brighter, more defined octaves |
| **Mix** | 0–100% | 100% | Blends the octave voices with the dry signal. At 100%, all enabled octave voices are fully present. Reducing Mix lowers the octave contribution without independently adjusting Octave Up/Down |
