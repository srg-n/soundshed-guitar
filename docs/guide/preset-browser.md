...
- **Community** — presets downloaded from the community (see [Community & Tone3000](community.md))
...
1. Click **New Setlist** in the setlist panel.
2. Drag presets from the browser into the setlist in the order you want.
3. Use the up/down arrows on stage (or MIDI pedal if configured) to step through the setlist.
